...
if(CMAKE_INSTALL_COMPONENT STREQUAL "AnalyzeInstrPass" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/AnalyzeInstrPass.so" AND
    ...
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/AnalyzeInstrPass.so"
         OLD_RPATH "\$ORIGIN/../lib:/home/chrinovic/llvm-build/./lib:"
         NEW_RPATH "\$ORIGIN/../lib")
    if(CMAKE_INSTALL_DO_STRIP)
      execute_process(COMMAND "/usr/bin/strip" "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/AnalyzeInstrPass.so")
    endif()
  endif()
endif()
